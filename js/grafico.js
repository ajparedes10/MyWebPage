...
for (var s in skills) {
  $(".grafica").append('<div class="pentagon" id="interests"><div class="headerGraph"></div><canvas class="pentCanvas"/></div>');
...
$(".pentagon").each(function(index){
  ...
  ctx.fillStyle = color;
  ctx.fillText(skills[pentagonIndex].headerGraph, width/2, 15);
